...
test('Numbers ending with 1 are written correctly', () => {
  expect(getCardinalNumber(81)).toBe('ottantuno')
  })

test('Numbers ending with 8 are written correctly', () => {
  expect(getCardinalNumber(921)).toBe('novecentoventuno')
    })
...
test('Writes 1,000,000 correctly', () => {
  expect(getCardinalNumber(1000000)).toBe('unmilione')
  })

test('Writes 1,000,000,000 correctly', () => {
  expect(getCardinalNumber(1000000000)).toBe('unmiliardo')
  })